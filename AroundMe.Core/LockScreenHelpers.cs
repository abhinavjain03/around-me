...
namespace AroundMe.Core
{
    public class LockScreenHelpers
    {
        ...
        public static void SaveSelectedBackgroundScreens(List<FlikrImage> data)
        {
        ...
        public static async Task SetRandomImageFormLocalStorage()
        {
            string fileData;
            using (IsolatedStorageFile storageFolder = IsolatedStorageFile.GetUserStoreForApplication())
            {
            ...
            images=JsonConvert.DeserializeObject<List<FlikrImage>>(fileData);
